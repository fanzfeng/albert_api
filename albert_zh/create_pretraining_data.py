...
flags.DEFINE_string("input_file", ",".join(["/data/fanzhengfeng/data/za_data/ds_corpus/c{}.txt".format(i) for i in range(27)]),
                    "Input raw text file (or comma-separated list of files).")

flags.DEFINE_string(
    "output_file", ",".join(["/data/fanzhengfeng/project/albert_zh/data/za_corpus_tf/c{}.tf".format(i) for i in range(27)]),
    "Output TF example file (or comma-separated list of files).")

flags.DEFINE_string("vocab_file", "/data/fanzhengfeng/project/albert_zh/albert_tiny_489k/vocab.txt",
